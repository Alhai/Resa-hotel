    ...
    <div className="restaurant-page">
      ...
      <div className="content">
        <div className="description">
          ...
          <p>
            Bienvenue dans notre restaurant ! Nous offrons une variété de plats
            délicieux préparés à partir des ingrédients les plus frais. Nos
            chefs sont dédiés à vous offrir une expérience culinaire
